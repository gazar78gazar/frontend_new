...
import { Check, ChevronRight, ChevronDown, MessageSquare, Download, Upload, Plus, Share, Settings, FileText, Wand2, AlertTriangle, Paperclip, X, AlertCircle, Info } from 'lucide-react';
      ...
      <div className="w-96 bg-white border-l shadow-lg flex flex-col">
        ...
        <div className="p-4 border-t">
          <div className="flex items-center space-x-2 mb-3">
            <button 
              disabled
              className="p-2 text-gray-400 hover:text-gray-600 cursor-not-allowed"
            >
              <Paperclip className="w-5 h-5" />
            </button>
            <span className="text-xs text-gray-500">File upload disabled</span>
          </div>
          ...
          <div className="flex space-x-2">
            <input
              ...
              placeholder="ReqMas integration pending..."
